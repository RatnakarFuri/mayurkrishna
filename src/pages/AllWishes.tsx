...
const AllWishes: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-baby-blue to-white">
      <div className="max-w-6xl mx-auto pt-12 pb-24 px-4">
        ...
        <motion.h1 
          className="text-4xl md:text-6xl text-center font-handwritten mb-12"
        ...
        {wishes.length > 0 ? (
          ...
          <div className="text-center py-12 watercolor-card">
            <p className="text-xl mb-4">No wishes have been shared yet.</p>
