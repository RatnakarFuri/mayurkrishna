...
const GuestWall: React.FC = () => {
  ...
  return <section id="guest-wall" className="relative py-20">
      <div className="max-w-6xl mx-auto">
        <motion.h2 className="text-4xl md:text-5xl text-center mb-12" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        {visibleWishes.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          </div> : <motion.div className="text-center mb-12" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
        once: true
            ...
            <p className="text-xl font-medium">Send your blessing!</p>
          </motion.div>}
